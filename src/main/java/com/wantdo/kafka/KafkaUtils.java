...
public class KafkaUtils {
    ...
    private static final String BOOTSTRAP_SERVERS = "192.168.125.222:9092";
    private static final String TOPIC_NAME = "aabb";
    ...
    public static void sendMsgToKafka(IpranAlarm msg) {
        producer.send(new ProducerRecord<String, String>(TOPIC_NAME, String.valueOf(System.currentTimeMillis()), JSON.toJSONString(msg)));
    }
