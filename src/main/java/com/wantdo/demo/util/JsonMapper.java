...
public class JsonMapper extends ObjectMapper {
	...
	public JsonMapper(Include include) {
		...
		this.registerModule(new SimpleModule().addSerializer(String.class, new JsonSerializer<String>() {
			...
			public void serialize(String value, JsonGenerator jsonGenerator, SerializerProvider provider) throws IOException {
				jsonGenerator.writeString(StringEscapeUtils.unescapeHtml(value));
			}
		}));
		// 设置时区
	 ...
	 * 构造Map类型.
	 *
	 * @param mapClass   需要构造的类型
	 * @param keyClass   泛型key
	 * @param valueClass 泛型 value
	 * @return 构造后的对象
	 */
